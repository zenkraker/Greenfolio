...
using Greenfolio.API.Core.ProjectAggregate;
using Greenfolio.API.Core.Services;
using Greenfolio.API.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Greenfolio.API.UnitTests.Core.Services
{
